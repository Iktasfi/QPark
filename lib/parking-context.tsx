...
const translations = {
  en: {
    ...
    resolve: "Resolve",
    fine: "Fine User",
    finishParking: "Finish Parking",
    startParking: "Start Parking",
    moveToNewSpot: "Move to new spot",
    moveToNewSpotDesc: "Drive to the spot — LPR will register you",
    insideWaiting: "You're inside — waiting for resolution",
    adminFindingSpot: "Admin is finding you a new spot",
    findAndParkSpot: "Find and park in your spot",
    meterStartsAfter: "Meter starts after",
    rateLabel: "Rate", rateValue: "150 ₸/hr, then 3 ₸/min",
    timeLabel: "Time",
  ...
  kk: {
    ...
    resolve: "Шешу",
    fine: "Айыппұл",
    finishParking: "Тұрақты аяқтау",
    startParking: "Тұрақтауды бастау",
    moveToNewSpot: "Жаңа орынға жылжыңыз",
    moveToNewSpotDesc: "Орынға кіріңіз — LPR тіркейді",
    insideWaiting: "Сіз ішіндесіз — шешімді күтіңіз",
    adminFindingSpot: "Әкімші жаңа орын іздейді",
    findAndParkSpot: "Орынды тауып, тұрыңыз",
    meterStartsAfter: "Есептегіш кейін басталады",
    rateLabel: "Тариф", rateValue: "150 ₸/сағ, одан 3 ₸/мин",
    timeLabel: "Уақыт",
  ...
  ru: {
    ...
    resolve: "Решить",
    fine: "Штраф",
    finishParking: "Завершить парковку",
    startParking: "Начать парковку",
    moveToNewSpot: "Переместитесь на новое место",
    moveToNewSpotDesc: "Заедьте на место — LPR зафиксирует",
    insideWaiting: "Вы внутри — ожидайте решения",
    adminFindingSpot: "Администратор ищет вам новое место",
    findAndParkSpot: "Найдите и займите место",
    meterStartsAfter: "Счётчик начнётся после",
    rateLabel: "Тариф", rateValue: "150 ₸/час, далее 3 ₸/мин",
    timeLabel: "Время",
