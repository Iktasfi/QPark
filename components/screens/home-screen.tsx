  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <div className="px-6 py-4 pb-24">
          ...
          <div className="bg-[#F0EDED] dark:bg-gray-800 rounded-[20px] p-5 mb-8" style={{boxShadow: '0 10px 20px rgba(0,0,0,0.08)'}}>
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-4">
                ...
                />
                <div>
                  <h3 className="text-[#333333] dark:text-white font-extrabold text-lg drop-shadow-md">Active Booking</h3>
        ...
        <div className="mb-8">
          <div className="grid grid-cols-2 gap-6">
            <button
              ...
              className="bg-[#F0EDED] dark:bg-gray-800 rounded-[20px] p-5 text-left hover:bg-[#E5DCDC] dark:hover:bg-gray-700 transition-colors"
              style={{boxShadow: '0 10px 20px rgba(0,0,0,0.08)'}}
            >
              <h4 className="text-[#333333] dark:text-white font-extrabold text-lg mb-3">Short-term</h4>
              <p className="text-gray-600 dark:text-gray-400 text-sm mb-4">12 spots available</p>
            ...
            <button
              ...
              style={{boxShadow: '0 10px 20px rgba(0,0,0,0.08)'}}
            >
              <h4 className="text-[#333333] dark:text-white font-extrabold text-lg mb-3">Long-term</h4>
              <p className="text-gray-600 dark:text-gray-400 text-sm mb-4">8 spots available</p>
              <div className="flex gap-2">
                {[1,2].map(i => (
                  <div key={i} className="w-3 h-3 bg-green-500 rounded-full"></div>
                ))}
        ...
        {/* Quick Actions */}
        <div className="mb-8">
          <h3 className="text-[#333333] dark:text-white font-extrabold text-lg mb-6">Quick Actions</h3>
