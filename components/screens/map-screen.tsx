...
const statusConfig: Record<SpotStatus, {
  ...
  OCCUPIED: { color: "text-gray-600 dark:text-gray-400", bg: "bg-gray-500", icon: Car, label: "Occupied" },
      ...
      <div className="bg-white dark:bg-gray-800 shadow-sm px-4 py-3">
        <div className="flex items-center justify-between">
          ...
          <div className="text-center">
            <h1 className="text-lg font-bold text-gray-900 dark:text-white drop-shadow-sm">Parking Map</h1>
            <p className="text-sm text-gray-600 dark:text-gray-400">Astana, Central Location - 30 spots</p>
          </div>
          <div className="w-9" />
        </div>
      </div>
        ...
        <div className="flex flex-wrap gap-2 justify-center">
          {Object.entries(statusConfig).map(([status, config]) => (
            <Badge
              key={status}
              variant="outline"
              className="gap-1.5 px-3 py-1.5 text-xs border-gray-300 dark:border-gray-600 dark:text-gray-300 rounded-full"
            >
      ...
      <div className="px-4 py-4 pb-24 space-y-6">
        ...
        <div>
          <div className="mb-3 flex items-center justify-between">
            <h2 className="font-semibold text-gray-900 dark:text-white">Short-term (SP-01 to SP-15)</h2>
        ...
        <div>
          <div className="mb-3 flex items-center justify-between">
            <h2 className="font-semibold text-gray-900 dark:text-white">Long-term (SP-16 to SP-30)</h2>
